...
if preprocess:
    ...
    df = pd.read_csv("LABELED_2023-02-09_LVL5-FILTER_FILE-OLECF-WEBHIST-LNK_test_timeline1.txt", header=0,
    ...
    # LABELED_2023-02-09_LVL5-FILTER_FILE-OLECF-WEBHIST-LNK-FIRST_DIR-MSG_LEN-test_timeline1
    #df_transformed.to_csv("LABELED_ENCODED_2023-02-09_LVL5-FILTER_FILE-OLECF-WEBHIST-LNK-MSG_LEN-KEY_DIR-training_timeline1.txt",index=False)
    df_transformed.to_csv("LABELED_ENCODED_2023-02-09_LVL5-FILTER_FILE-OLECF-WEBHIST-LNK-MSG_LEN-KEY_DIR-test_timeline1.txt", index=False)
    exit()
############################################################################
normal_clf = True
if normal_clf:
    ...
    # read in dataset1.csv
    df1 = pd.read_csv(
        "LABELED_ENCODED_2023-02-09_LVL5-FILTER_FILE-OLECF-WEBHIST-LNK-MSG_LEN-KEY_DIR-training_timeline1.txt")
    df2 = pd.read_csv(
        "LABELED_ENCODED_2023-02-09_LVL5-FILTER_FILE-OLECF-WEBHIST-LNK-FIRST_DIR-MSG_LEN-test_timeline1.txt")
    ...
    # X test, y test
    X_test = df2_test.drop(["datetime", "tag"], axis=1)
    y_test = df2_test.tag

    # check to see if decision tree pruned is good...
    ...
    if test_best_model:
        # Test the best model
        best_model = df1_train_models['Random_Forest']
        ...
        util.visualize_model(best_model, 'Logistic Regression', X_test, y_test )
